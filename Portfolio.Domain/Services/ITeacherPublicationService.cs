...
namespace Portfolio.Domain.Services
{
    public interface ITeacherPublicationService
    {
        ...
        Task<IEnumerable<Dissertation>> GetAllDissertations(Guid id);
        ...
        Task<Dissertation> GetDissertation(Guid id, Guid entityId);
        ...
        Task<Guid> AddDissertation(Guid id, Dissertation entity);
        ...
        Task UpdateDissertation(Guid id, Dissertation entity);
