...
public class Callback : PageModel
{
    ...
    public Callback(IIdentityServerInteractionService interaction, IEventService events, ILogger<Callback> logger, UserManager<IdentityUser<Guid>> userManager, SignInManager<IdentityUser<Guid>> signInManager)
    {
    ...
    private async Task<IdentityUser<Guid>> AutoProvisionUserAsync(string provider, string providerUserId,
