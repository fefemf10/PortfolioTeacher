...
namespace Portfolio.Application.ViewModels.Request
{
    ...
    public record RequestMonography([Required] string Name, [Required] int YearPublication, List<Guid> CoAuthors, List<Guid> Files, string? Publisher, [Required] int Circulation, [Required] int CountPages) : RequestPublication(Name, YearPublication, CoAuthors, Files);
