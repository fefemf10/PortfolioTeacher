...
namespace Portfolio.Infrastructure.Migrations
{
    ...
    [Migration("20250419103604_dateaward to not null")]
    partial class dateawardtonotnull
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portfolio.Domain.Models.Discipline", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("DisciplineTeacher", b =>
                {
                    b.HasOne("Portfolio.Domain.Models.Discipline", null)
                        .WithMany()
